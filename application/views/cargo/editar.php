	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="x_panel">
			...
			<div class="x_content"> 
				...
				<!-- Inicio do formuário -->
				<?php echo form_open('cargo/editar/'.$obj->getId_cargo(),array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
				 <input type="hidden" name="id_cargo" value="<?php echo $obj->getId_cargo(); ?>"> 
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
							<label>Cargo</label>
							<input type="text" class="form-control" name="cargo" id="cargo" value="<?php echo set_value('cargo',$obj->getCargo())?>" />
						</div>
