<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Pesquisa de Cargos</h2>
          <ul class="nav navbar-right panel_toolbox">
          <li><a href="<?php echo site_url('cargo/cadastrar'); ?>"><i class="fa fa-plus-circle"></i> <strong>Novo Cargo</strong></a></li>
        ...
        <div class="x_content"> <!-- INICIO MIOLO-->
          ...
          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
              <?php foreach ($list as $objCargo): ?>
                 <tr class="dadosTabela">
                  <td><?php echo $objCargo->getCargo(); ?></td>
  
          
                  <td class="td-actions">
                  <a href="<?php echo site_url('cargo/editar/'.$objCargo->getId_cargo()); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Editar</a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div id="testmodal">
                 ...
                 <form class="form-horizontal" method="post" id="forgot_form" action="<?php echo base_url(); ?>cargo/filtro/">
...
$(function () {
 ...
 //OPERAÇÃO EXCLUSÃO 
  ...
  $('#btnYes').click(function() {
    ...
    location.href="<?php echo site_url('cargo/excluir'); ?>/"+id;
