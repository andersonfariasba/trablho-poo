	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="x_panel">
			...
			<div class="x_content"> 
				...
				<!-- Inicio do formuário -->
				<?php echo form_open('colaborador/cadastrar',array("onsubmit"=>"return validate()","class"=>"form-horizontal")); ?>
					 ...
					 <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
							<label>Cargo</label>
								<select class="form-control" name="id_cargo" id="id_cargo">
									...
									<option value="<?php echo $objCargo->getId_cargo(); ?>">
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
							<label>CPF</label>
							<input type="text" class="form-control" name="cpf" id="cpf" value="<?php echo set_value('cpf')?>" />
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
							<label>Salário</label>
							<input type="text" class="form-control" tipo="moneyReal" name="salario" id="salario" value="<?php echo set_value('salario')?>" />
						</div>
